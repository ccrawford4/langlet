...
@MainActor
final class TranslationTimer: ObservableObject {
     ...
     */
    func reset(lengthInMinutes: Int, speakers: [Speaker] = []) {
        self.lengthInMinutes = lengthInMinutes
        self.speakers = speakers
        secondsRemaining = lengthInSeconds
        activeSpeaker = speakerText
...
/* TODO: Consider ML and NLP for Processing and Giving the name of the person recording
 extension Array<Speaker> {
